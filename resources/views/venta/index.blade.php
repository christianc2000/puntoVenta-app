                        ...
                        <table id="table" class="table table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="accion" colspan="1">OPCIONES</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($notaventas as $nv)
                                    <tr>
                                        ...
                                        <td class="p-2">
                                            @if ($nv->estado)
                                                <div
                                                    style="text-align: center; border-radius: 10px; background: #00A65A; color:white">
                                                    <strong>REALIZADO</strong>
                                                </div>
                                            @else
                                                <div
                                                    style="text-align: center; border-radius: 10px; background: #DD4B39; color:white">
                                        ...
                                        <td class="tdDatos">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <a class="btn btn-warning text-white px-2"
                                                        href="{{ route('ventas.show', $nv->id) }}">
                                                        <i class="fa fa-solid fa-eye"style="font-size: 15px;"></i>
                                                    </a>
                                                </div>
                                                <div class="col-md-6">
                                                    <form action="{{ route('ventas.anular', $nv->id) }}" method="POST">
                                                        @csrf
                                                        <button class="btn btn-danger text-white"
                                                            style="padding: 5px; width: 30px;" type="button">
